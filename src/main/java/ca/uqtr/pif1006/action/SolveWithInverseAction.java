...
public class SolveWithInverseAction extends Action {
    public SolveWithInverseAction(Menu menu) {
        super(menu);
    }
    ...
    public void execute() {
        try {
            Matrix2D solution = this.getMenu().getSystem().solveUsingInverseMatrix();
